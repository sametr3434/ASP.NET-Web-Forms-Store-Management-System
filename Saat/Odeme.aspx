    ...
    <div class="main-content-wrapper">
        <div class="checkout-area pt--40 pb--80">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <asp:Panel ID="pnlKayitliAdres" runat="server" Visible="false" CssClass="form-group mb-3">
                            <label>Kayıtlı adres seçin</label>
                            <asp:DropDownList ID="ddlKayitliAdres" runat="server" CssClass="form-control"
                                AutoPostBack="true" OnSelectedIndexChanged="ddlKayitliAdres_SelectedIndexChanged" />
                        </asp:Panel>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <asp:TextBox ID="txtPostaKodu" runat="server" CssClass="form-control" />
                            </div>
                        </div>
                        <asp:Panel ID="pnlAdresKaydet" runat="server" Visible="false" CssClass="form-group mb-3">
                            <asp:CheckBox ID="chkAdresKaydet" runat="server" Text=" Bu adresi adres defterime kaydet" />
                            <asp:TextBox ID="txtYeniAdresBaslik" runat="server" CssClass="form-control mt-2"
                        ...
                        <asp:Label ID="lblHata" runat="server" CssClass="text-danger d-block mt-2"></asp:Label>
                    </div>
                    <div class="col-md-5">
