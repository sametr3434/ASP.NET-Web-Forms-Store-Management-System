...
<%@ Import Namespace="Saat.App_Code" %>
...
<script RunAt="server">
    ...
    void RegisterRoutes(RouteCollection routes)
    {
        ...
        routes.MapPageRoute("odeme", "odeme", "~/Odeme.aspx");
        routes.MapPageRoute("odemeode", "odeme-ode", "~/OdemeOde.aspx");
        routes.MapPageRoute("odemebasarili", "odeme-basarili", "~/OdemeBasarili.aspx");
        routes.MapPageRoute("uyegiris", "uye-giris", "~/UyeGiris.aspx");
        routes.MapPageRoute("uyekayit", "uye-kayit", "~/UyeKayit.aspx");
        routes.MapPageRoute("uyecikis", "uye-cikis", "~/UyeCikis.aspx");
        routes.MapPageRoute("hesabim", "hesabim", "~/Hesabim.aspx");
    }
