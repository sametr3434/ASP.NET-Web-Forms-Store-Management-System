...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .product-img.single-image:hover .primary-image { opacity: 1 !important; visibility: visible !important; }
    </style>
</asp:Content>
...
<section class="mostviewed-product-area border-bottom pt--80 pb--60 pt-md--60 pb-md--50">
    <div class="container">
        ...
        <div class="row no-gutters">
                    ...
                    <asp:Repeater ID="rptEnCokGoruntulenen" runat="server">
                        <ItemTemplate>
                            ...
                            <div class="mirora-product">
                                <div class="product-img<%# IkinciResimVar(Eval("IkinciResim")) ? "" : " single-image" %>">
                                    <img src='Upload/<%# Eval("AnaResim") %>' 
                                         alt='<%# Eval("UrunAdi") %>' 
                                         class="primary-image" />
                                    <asp:PlaceHolder Visible='<%# IkinciResimVar(Eval("IkinciResim")) %>' runat="server">
                                    <img src='Upload/<%# Eval("IkinciResim") %>' 
                                         alt='<%# Eval("UrunAdi") %>' 
                                ...
                                <div class="mirora_product_action text-center position-absolute">
                                    ...
                                    <div class="product-action">
                                        <a class="add_cart cart-item action-cart" href='<%# UrunLink(Eval("ID"), Eval("UrunAdi")) %>' title="İncele">
                                            <span>İncele</span>
                                        </a>
                                    </div>
                                </div>
            ...
            <!-- Size Öneriyoruz Start -->
            <asp:Panel ID="pnlOneriler" runat="server">
            <section class="mostviewed-product-area border-bottom pt--60 pb--60">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title mb--15">
                                <h2>Size Öneriyoruz</h2>
                                ...
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb--30">
                                    <div class="mirora-product">
                                        <div class="product-img">
                                            <a href='<%# UrunLink(Eval("ID"), Eval("UrunAdi")) %>'>
                                                <img src='Upload/<%# Eval("AnaResim") %>' alt='<%# Eval("UrunAdi") %>' class="primary-image" />
                                            </a>
                                        </div>
                                        <div class="product-content text-center">
                                            <span><%# Eval("MarkaAdi") %></span>
                                            <h4><a href='<%# UrunLink(Eval("ID"), Eval("UrunAdi")) %>'><%# Eval("UrunAdi") %></a></h4>
        ...
        <ItemTemplate>
                                <article class="blog">
                                    <a href='<%# BlogLink(Eval("ID"), Eval("baslik")) %>' class="blog__thumb">
                                        <img src="Upload/<%#Eval("resim") %>" alt="Blog">
                                    </a>
                                    <div class="blog__content">
                                        <div class="blog__meta">
                                            <p class="blog__author"><a href='<%# BlogLink(Eval("ID"), Eval("baslik")) %>'><%#Eval("baslik") %></a></p>
                                            <p class="blog__date"><a href='<%# BlogLink(Eval("ID"), Eval("baslik")) %>'><%#Eval("tarih") %></a></p>
                                        </div>
                                        <h3 class="blog__title"><a href='<%# BlogLink(Eval("ID"), Eval("baslik")) %>'><%#Eval("kisaaciklama") %></a></h3>
                                        <div class="blog__text">
                                            <a class="read-more" href='<%# BlogLink(Eval("ID"), Eval("baslik")) %>'>Daha Fazlası</a>
                                        </div>
                                    </div>
                                </article>
        </ItemTemplate>
...
<asp:TextBox ID="txtKisiMailAdresi" PlaceHolder="E-Posta Adresiniz" runat="server"></asp:TextBox>
        <asp:Button ID="btnMailAdresiKayiEt" OnClick="btnMailAdresiKayiEt_Click" runat="server" Text="Abone Ol" />
                                </div>
                            </div>
                        </div>
                    </div>
