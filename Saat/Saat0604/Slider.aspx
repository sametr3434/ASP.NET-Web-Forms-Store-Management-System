<%@ Page Title="" Language="C#" MasterPageFile="~/Saat0604/MasterPage.Master" AutoEventWireup="true" CodeBehind="Slider.aspx.cs" Inherits="Saat.Saat0604.Slider" %>
                ...
                <asp:Panel ID="Panel1" runat="server" Visible="false">
                    <fieldset class="mb-3">
                        <div class="form-group row">
                            ...
                            <label class="col-sm-7 control-label" for="input01" style="margin-top: 8px;">1.300 x 975 Ebat Uygulanacaktır</label>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 control-label" for="input01" style="margin-top: 8px;">Yazı 1</label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtYazi1" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 control-label" for="input01" style="margin-top: 8px;">Yazı 2</label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtYazi2" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 control-label" for="input01" style="margin-top: 8px;">Yazı 3</label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtYazi3" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row" >
                            <label class="col-sm-2 control-label" for="input01" style="margin-top: 8px;">Link Var / Yok</label>
                            <div class="col-sm-2">
                                <asp:RadioButtonList ID="rbLinkVarYok" runat="server" class="form-control" RepeatColumns="2">
                                    <asp:ListItem Value="1" Selected="True">Evet</asp:ListItem>
                                    <asp:ListItem Value="0">Hayır</asp:ListItem>
                                </asp:RadioButtonList>
                            </div>
                        ...
                        <div class="form-group row" >
                            <label class="col-sm-2 control-label" for="input01" style="margin-top: 8px;">Link</label>
                            <div class="col-sm-10">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Bu sayfa &#252;zerinde yapacak oldu&#287;unuz tan&#305;mlamalar; anasayfada bulunan slider b&#246;l&#252;m&#252;n&#252;n i&#231;eri&#287;ine kaydedilecektir.</p>
                    <p><strong>Resim:</strong> 1300 x 975 piksel ebat &#246;nerilir. Y&#252;kledikten sonra k&#305;rpma alan&#305; ile kesim yap&#305;l&#305;r.</p>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScript" runat="server">
    ...
    <script type="text/javascript">
        ...
        function size() {//resim boyut kontrolü
            ...
            if (width >= 1300 && height >= 975) {//minmum genişlik ve yükseklik kontrolü
                ...
                alert('Minimum ebat 1300X975 olmalı');//Resim boyutu uyarısı
        ...
        function crop() {//Kırpma işlemi
            ...
            jQuery(document).ready(function () {
                jQuery('#ContentPlaceHolder1_Image1').Jcrop({
                    ...
                    minSize: [1300, 975],//minimum dosya boyutu genişlik,yükselik
                    setSelect: [0, 0, 1300, 975],//seçimalanını göster
                    aspectRatio: 1300 / 975,//genişlik bölü yükseklik oranı (Buradaki değer olması gereken resmin genişliğin yüksekliğe oranı tamsayı olarak yerleşecek ör: 0.5 yerine 1/2 yazılacak)
