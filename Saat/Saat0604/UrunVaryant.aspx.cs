...
namespace Saat.Saat0604
{
    public partial class UrunVaryant : Page
    {
        ...
        private void KasaBoyutlariniDoldur()
        {
        ...
        protected void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            int? kasaId = string.IsNullOrEmpty(ddlBeden.SelectedValue) ? (int?)null : Convert.ToInt32(ddlBeden.SelectedValue);
