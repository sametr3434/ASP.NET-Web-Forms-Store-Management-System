<%@ Page Title="Renk Yönetimi" Language="C#" MasterPageFile="~/Saat0604/MasterPage.Master" AutoEventWireup="true" CodeBehind="RenkEkle.aspx.cs" Inherits="Saat.Saat0604.RenkEkle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Panel</span> - Renk Yönetimi</h4>
            </div>
        </div>
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="/Saat0604/RenkListe.aspx" class="breadcrumb-item">Renk Listesi</a>
    ...
    <div class="content">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Renk Yönetimi</h5>
                <div class="header-elements">
                    <a href="RenkListe.aspx" class="btn btn-secondary btn-lg ml-2"><i class="icon-list2 mr-2"></i>Listeye Dön</a>
                </div>
            </div>
            ...
            <div class="card-body">
                <asp:Panel ID="pnlForm" runat="server">
                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">Renk Bilgileri</legend>

                        <div class="form-group row">
                            <label class="col-sm-2 control-label" style="margin-top: 8px;">Renk Adı</label>
                            <div class="col-sm-6">
                                <asp:TextBox ID="txtRenkAdi" runat="server" class="form-control" placeholder="Örn: Siyah, Beyaz..."></asp:TextBox>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-sm-2 control-label" style="margin-top: 8px;">Renk Kodu</label>
                            <div class="col-sm-6">
                                <asp:TextBox ID="txtRenkKodu" runat="server" class="form-control" placeholder="#000000"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <asp:Label ID="lblRenkID" runat="server" Visible="false"></asp:Label>
                            </div>
                        </div>
                    </fieldset>
                </asp:Panel>
        ...
        <div class="modal-dialog modal-md modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6 class="font-weight-semibold">Renk Yönetim Sayfas&#305;</h6>
                    <p>Bu sayfa, renk ekleme, d&#252;zenleme ve y&#246;netimi i&#231;in kullan&#305;l&#305;r.</p>
                </div>
            </div>
        </div>
    </div>
