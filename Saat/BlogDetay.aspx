                                            ...
                                            <div class="col-lg-4 mb-md--30">
                                                <div class="related-post">
                                                    <a href='<%# string.Format("/blogdetay/{0}/{1}", Eval("ID"), Temizle.UrlCevir(Eval("baslik").ToString())) %>' class="related-post__thumb">
                                                        <img src="/Upload/<%#Eval("Resim") %>" alt="<%# Duzelt(Eval("baslik")) %>">
                                                    </a>
                                                    <h4><a href='<%# string.Format("/blogdetay/{0}/{1}", Eval("ID"), Temizle.UrlCevir(Eval("baslik").ToString())) %>'><%# Duzelt(Eval("baslik")) %></a></h4>
