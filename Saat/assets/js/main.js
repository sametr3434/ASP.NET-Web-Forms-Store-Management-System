(function($){
	...
	***********************/
    ...
    function scrollToTop(){
		...
		if (!scrollTop.length || scrollTop.data("saatInit")) return;
		scrollTop.data("saatInit", true);

		function guncelle() {
			var topPos = $(window).scrollTop();
			if (topPos > 100) {
				scrollTop.addClass("is-visible").css("opacity", "");
			} else {
				scrollTop.removeClass("is-visible").css("opacity", "");
			}
		}

		$(window).on('scroll', guncelle);
		guncelle();
