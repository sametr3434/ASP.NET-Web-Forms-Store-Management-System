...
<!-- Google Map End -->
            ...
            <div class="contact-area ptb--80 ptb-md--60">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="heading-secondary border-bottom mb--30">PROJENİZİ BİZE ANLATIN</h2>
                            <div class="form form--contact" id="contact-form" action="https://htmldemo.net/mirora/mirora/mail.php">
...
<div class="col-md-10">
    <asp:TextBox ID="txtEmail" placeholder="Email Adresiniz" runat="server"
        style="width:100%; background:transparent; border:none; border-bottom:1.5px solid rgba(255,255,255,0.3); outline:none; padding:12px 4px; font-size:15px; color:#ffffff; margin-bottom:24px; display:block; box-sizing:border-box; border-radius:0;">
    </asp:TextBox>
</div>
<div class="col-md-10">
    <asp:TextBox ID="txtTelefon" placeholder="Telofon Numarınız" runat="server"
        style="width:100%; background:transparent; border:none; border-bottom:1.5px solid rgba(255,255,255,0.3); outline:none; padding:12px 4px; font-size:15px; color:#ffffff; margin-bottom:24px; display:block; box-sizing:border-box; border-radius:0;">
    </asp:TextBox>
</div>
<div class="col-md-10">
