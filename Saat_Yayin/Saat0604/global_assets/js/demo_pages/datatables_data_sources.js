    ...
    var _componentDatatableDataSources = function() {
        ...
        $.extend( $.fn.dataTable.defaults, {
            ...
            language: {
                ...
                lengthMenu: '<span>Showx:</span> _MENU_',
        ...
        $('.datatable-ajax').dataTable({
            ajax: '/Saglayici0105/global_assets/demo_data/tables/datatable_ajax.json'
        });
        ...
        $('.datatable-nested').dataTable({
            ajax: '/Saglayici0105/global_assets/demo_data/tables/datatable_nested.json',
            columns: [
                {data: "name[, ]"},
                {data: "hr.0" },
                {data: "office"},
